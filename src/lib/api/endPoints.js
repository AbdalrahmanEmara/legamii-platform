...
export const ENDPOINTS = {
  ...
  student_contest: {
    ...
    questions: (studentContestId) =>
      `${v}/student-contest/${studentContestId}/questions`,
    ...
    finish: (studentContestId) =>
      `${v}/student-contest/${studentContestId}/finish`,

    summary: (studentContestId) =>
      `${v}/student-contest/${studentContestId}/summary`,

    detailedSummary: (studentContestId) =>
      `${v}/student-contest/${studentContestId}/detailed-summary`,

    rank: (studentContestId) =>
      `${v}/student-contest/${studentContestId}/rank`,
  },
  subject: {
