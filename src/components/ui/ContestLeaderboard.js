...
// export default function ContestLeaderboard({ students = [], currentUserId, scoreAnimationAmount = 0, scoreAnimationUserId = null }) { 
...
//               <div
//                 key={user.id}
//                 className={`px-sm py-base gap-base flex items-center self-stretch border-b border-[#020203] ${
//                   isTopOne
//                     ? "bg-primary-300" 
//                     : isTopTwo
//                       ? "bg-primary-200"
