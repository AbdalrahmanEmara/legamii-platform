    ...
    <div className="flex w-full items-center justify-between rounded-lg border-[1.5px] border-text bg-white p-base shadow-[2px_3px_4px_0_rgba(0,0,0,1)]">
      <div className="flex items-center gap-base">
        ...
        <div className="flex flex-col gap-xs2">
          ...
          {isOngoing ? (
            <div className="inline-flex w-fit items-center justify-center bg-green-600 px-xs py-1 text-white">
              <span className="font-primary text-xs tracking-wider">
                LIVE
              </span>
            </div>
          ) : isUpcoming && isRegistered ? (
            <div className="inline-flex w-fit items-center justify-center bg-secondary-500 px-xs py-1 text-white">
              <span className="font-primary text-xs tracking-wider">
                REGISTERED
              </span>
            </div>
      ...
      {/* Action Button */}
      <Button onClick={handleContestClick} disabled={isDisabled} className="px-md py-sm hover:bg-primary-600 transition-colors">
