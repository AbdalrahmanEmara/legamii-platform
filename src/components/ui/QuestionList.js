...
export default function QuestionList({ questions, currentIndex, answers }) {
  return (
    //  true w : 196
    <div className="border-[#020203] flex h-full w-[230px] flex-col border-r bg-white">
      {/* Header */}
      <div className="border-[#020203] bg-color-white flex items-center justify-center border-b px-6 py-2">
        <span className="font-primary text-text text-sm leading-[24px] font-normal tracking-[0]">
          Question List
        </span>
      </div>
      {/* Body */}
      <div className="flex flex-1 flex-col gap-2 overflow-y-auto bg-white px-6 py-2 border border-border">
        {/* Questions label */}
