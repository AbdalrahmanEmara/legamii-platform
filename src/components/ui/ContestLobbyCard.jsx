...
*/
  ...
  useEffect(() => {
    if (contest?.contestStatus !== "ONGOING" || !startDate) return;
  ...
  }, [contest?.contestStatus, startDate]);
    ...
    if (
      ...
      router.push(
        // `/student/contests/play/${res.studentContestId}`
         ...
         `/student/contests/play/${res.studentContestId}?title=${encodeURIComponent(contest.contestTitle)}&start=${encodeURIComponent(contest.contestStartingTime)}&duration=${contest.contestTimeLimit}`
      );
          ...
          <div className="flex items-start justify-between">
            <div className="flex gap-6">
              ...
              <div className="flex flex-col justify-center gap-1">
                {contest.contestStatus === "ONGOING" && (
                  <div className="font-primary flex w-fit items-center gap-2 rounded-sm border border-black bg-green-600 px-2 py-1 text-[11px] text-white uppercase shadow-[1px_1px_0px_0px_#000]">
                    <span>LIVE</span>
