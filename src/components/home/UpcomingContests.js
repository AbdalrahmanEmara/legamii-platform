    ...
    <ReusableWindow title="upcoming_contests.sys" className="w-full">
      <div className="p-base flex flex-col gap-base">
        ...
        <div className="flex flex-col gap-base">
          ...
          <Link href="/student/contests" className="flex justify-center align-center text-text text-xs md:text-sm md:leading-5 2xl:text-base font-normal font-primary leading-4 py-sm px-[32px] border border-border rounded-lg">
            View All Contests
          </Link>
        </div>
      </div>  
