...
import TeacherAIQuestionModal from "@/components/teacher/question-bank/TeacherAIQuestionModal";
...
export default async function AddAITeacherQuestionPage({ searchParams }: { searchParams: any }) {
